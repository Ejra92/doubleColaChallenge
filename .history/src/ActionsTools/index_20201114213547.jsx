...
export default ({onHowManyChanges, count, howManyTimes, stopOrContinue, restart, showThis5, stop, lastToTakeNDoubleCola}) =>
        <section className="ActionsTools">
            ...
            <div className="actionsButtons">
                {count !== howManyTimes && !lastToTakeNDoubleCola && <button disabled={!howManyTimes ? true : false} onClick={stopOrContinue}>{stop ? `${showThis5.length === 5 ? 'Iniciar' : 'Continuar'}` : 'Detener'}</button>}
