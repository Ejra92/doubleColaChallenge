...
export default function App() {
  ...
  const whoIsNext = () => finalQueue.length === 0 ? setLastToTakeNDoubleCola(showThis5[showThis5.length - 1]) : nextToTakeADoubleCola = setTimeout(()=> setShowThis5([...showThis5, finalQueue.shift()]), 1000)
