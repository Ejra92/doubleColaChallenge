...
export default function App() {
  ...
  return (
    <div className="App">
      ...
      <p>{showThis5.length > 0 && showThis5[finalQueue.length - 2]} </p>

      <p>{showThis5.length > 0 && showThis5[finalQueue.length - 3]} </p>

      <p>{showThis5.length > 0 && showThis5[finalQueue.length - 4]} </p>

      <p>{showThis5.length > 0 && showThis5[finalQueue.length - 5]} </p>
    </div>
  )
}