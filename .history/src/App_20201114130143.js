...
export default function App() {
  ...
  return (
    <div className="App">
      ...
      <p>{showThis5.length > 0 && showThis5[showThis5.length - 1]} </p>

      <p>{showThis5.length > 0 && showThis5[showThis5.length - 2]} </p>

      <p>{showThis5.length > 0 && showThis5[showThis5.length - 3]} </p>

      <p>{showThis5.length > 0 && showThis5[showThis5.length - 4]} </p>

      <p>{showThis5.length > 0 && showThis5[showThis5.length - 5]} </p>
    </div>
  )
}